...
STUDENT_TEST("duplicateNegatives, input has A FRONT negative") {
    Queue<int> q = {-7, 10};
    Queue<int> expected = {-7, -7, 10};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, input has A BACK negative") {
    Queue<int> q = {7, 10, -6};
    Queue<int> expected = {7, 10, -6, -6};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, input has A BACK AND A FRONT negative") {
    Queue<int> q = {-7, 10, -6};
    Queue<int> expected = {-7, -7, 10, -6, -6};
...
STUDENT_TEST("duplicateNegatives, input has ONLY negatives") {
    Queue<int> q = {-7, -10, -6};
    Queue<int> expected = {-7, -7, -10, -10, -6, -6};
